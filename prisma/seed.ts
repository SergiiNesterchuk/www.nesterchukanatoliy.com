...
<p>Продавець не несе відповідальності за затримки доставки, спричинені перевізником.</p>`,
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      title: "Накладений платіж з авансом 200 грн",
      description: "Аванс 200 грн онлайн, решта — при отриманні у Новій Пошті",
      customerInstruction: "Замовлення отримано! Аванс {prepaymentAmount} грн підтверджено ✅ Залишок {remainingAmount} грн ви сплатите при отриманні. Замовлення буде відправлено протягом 1–3 днів.",
      checkoutButtonLabel: "Підтвердити та оплатити 200 грн авансу",
      enabled: false,
      requiresOnlinePayment: true,
      sortOrder: 2,
    },
  ...
  // Blog posts (seed — won't overwrite existing)
  const blogPosts = [
    {
      slug: "naturalnyi-yabluchnyi-otset-koryst",
      title: "Натуральний яблучний оцет — користь, як правильно вживати та чим відрізняється від магазинного",
      excerpt: "Дізнайтеся про реальну користь натурального яблучного оцту, як відрізнити живий продукт від магазинного і як правильно його вживати.",
      content: "<h2>Що таке натуральний яблучний оцет?</h2><p>Натуральний яблучний оцет — це продукт бродіння свіжих яблук без додавання цукру, хімічних добавок та консервантів. На відміну від магазинних аналогів, він зберігає всі корисні ферменти, вітаміни та мінерали.</p><h2>Користь для здоровʼя</h2><ul><li>Покращує травлення</li><li>Підтримує імунітет</li><li>Допомагає контролювати вагу</li><li>Нормалізує рівень цукру в крові</li></ul><h2>Як правильно вживати?</h2><p>Розведіть 1 столову ложку оцту в склянці теплої води. Пийте за 20-30 хвилин до їжі. Не вживайте нерозведеним!</p>",
      coverImageUrl: "",
      isPublished: false,
      ctaLabel: "Купити яблучний оцет",
      ctaUrl: "/katalog/",
      sortOrder: 1,
    },
    {
      slug: "yak-pryhotuvaty-bordosku-sumish",
      title: "Як приготувати Бордоську суміш правильно — пропорції 1% і 3%, покрокова інструкція",
      excerpt: "Покрокова інструкція приготування Бордоської суміші для захисту саду від хвороб. Правильні пропорції для 1% та 3% розчину.",
      content: "<h2>Що таке Бордоська суміш?</h2><p>Бордоська суміш — це один з найефективніших засобів для захисту рослин від грибкових захворювань. Використовується садівниками вже більше 100 років.</p><h2>Пропорції 1% розчину</h2><p>На 10 літрів води: 100 г мідного купоросу + 100 г вапна.</p><h2>Пропорції 3% розчину</h2><p>На 10 літрів води: 300 г мідного купоросу + 300 г вапна. Застосовувати тільки рано навесні до розпускання бруньок.</p>",
      coverImageUrl: "",
      isPublished: false,
      ctaLabel: "Купити Бордоську суміш",
      ctaUrl: "/katalog/",
      sortOrder: 2,
    },
  ];
