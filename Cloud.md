...
> **CHANGELOG.md** — історія ключових змін, рішень і контексту. Cloud Code **повинен оновлювати CHANGELOG.md** після кожної значної зміни, щоб наступні сесії мали повний контекст.
