...
## 2026-05-14 — Заміна «передплата» на «аванс»

### Причина
Юридично передплата підлягає поверненню клієнту, якщо він не забрав товар. Аванс — ні. Тому всі тексти змінені на «аванс» для юридичного захисту ФОП.

### Що змінено
- **UI сайту**: checkout форма, success page, order-status, account orders — всюди "аванс" замість "передплата"
- **Інвойси WayForPay**: опис платежу тепер "Аванс X грн за замовлення..."
- **Email**: підтвердження оплати каже "Аванс X грн отримано"
- **KeyCRM**: описи платежів "WayForPay аванс X грн"
- **Seed**: метод оплати "Накладений платіж з авансом 200 грн"
- **Shared constants**: лейбли статусів оплати оновлені
- **Не змінено**: технічні змінні (prepaymentAmount, cod_prepayment, awaiting_prepayment) — лише UI тексти
...
## 2026-04-28 — Приховання COD авансу для замовлень <= 200 грн

### Проблема
"Накладений платіж з авансом 200 грн" не має сенсу якщо сума замовлення <= 200 грн (аванс = повна сума).
...
- **Payment method IDs**:
  ...
  - ID 12 = Аванс 200 грн (cod_prepayment)
